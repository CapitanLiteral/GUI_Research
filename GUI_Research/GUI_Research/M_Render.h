...
public:
	...
	bool Blit(SDL_Texture* texture, const SDL_Rect* _rect, const SDL_Rect* section = nullptr, int alpha = 255, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;
